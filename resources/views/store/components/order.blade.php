            ...
            <tr> 
                @switch($key) 
                    ...
                    @case('delivery_date')
                        <td> Delivery Date</td>
                        <td> 
                            <input type="datetime-local" value="{{strtotime($value) ? date('Y-m-d\TH:i', strtotime($value)) : null}}" name="delivery_date" />
                            {{-- <input type="datetime-local" value={{$value}} name="delivery_date" /> --}}
                        </td> 
                    @break 
