            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" id="registerForm">
                        ...
                        <div class="form-group row">
                            <label for="mobile" class="col-md-4 col-form-label text-md-right">{{_('Mobile Number') }}</label> 
                        ...
                        <div class="form-group row">
                            <label for="language-select" class="col-md-4 col-form-label text-md-right">{{ __('Preferred Language') }}</label>
                            <div class="col-md-6">
