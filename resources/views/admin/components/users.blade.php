        ...
        <tbody>
            @foreach($users as $user)
                <tr>
                    ...
                    <td> 
                        {{ link_to_action('AdminController@toggleAdmin', $user->designer ? 'Remove Designer' : 'Set Designer', ['id' => $user->id, 'type' => 'designer'], ['class' => $user->designer ? 'btn btn-danger' : 'btn btn-success']) }}
                    </td> 
                    <td> 
