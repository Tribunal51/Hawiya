            ...
            <div class="row">
                <div class="col-md">
                    ...
                    <div class="flex-container">
                        <button 
                            class="btn btn-outline-warning flexItem" 
    ...
    data() {
        return {
            services: [
                {
                    name: 'Logo Design',
                    link: '/design/logo-design/package'
                },
                {
                    name: 'Branding',
                    link: '/design/branding/package'
                },
                {
                    name: 'Social Media',
                    link: '/design/social-media/package'
                },
                {
                    name: 'Stationery',
                ...
                {
                    name: 'Packaging',
                    link: '/design/packaging/products'
                },
                {
                    name: 'Promotional',
